...
namespace Pinwheel.Griffin.URP
{
    ...
    public static class GGriffinUrpInstaller
    {
        ...
        public static void Install()
        {
            ...
            if ( resources == null )
                return;
            List<GRuntimeSettings.TerrainRenderingSettings.TerrainMaterialTemplate> terrainMaterialTemplates = new();
            terrainMaterialTemplates.Add( new GRuntimeSettings.TerrainRenderingSettings.TerrainMaterialTemplate
            {
        ...
        public static bool UpgradeMaterial( Material mat )
        {
            ...
            GRuntimeSettings.TerrainRenderingSettings.TerrainMaterialTemplate template;
