...
public class SwordVfxCameraHolder : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        if ( GUI.Button( new Rect( 120 * windowDpi, 5 * windowDpi, 110 * windowDpi, 35 * windowDpi ),
            "Play again" ) ) Counter( 0 );
        if ( GUI.Button( new Rect( 235 * windowDpi, 5 * windowDpi, 110 * windowDpi, 35 * windowDpi ),
            "Next effect" ) ) Counter( +1 );
