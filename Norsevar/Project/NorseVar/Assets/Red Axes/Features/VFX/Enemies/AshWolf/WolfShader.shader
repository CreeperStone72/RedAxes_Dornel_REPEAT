...
Shader "WolfShader"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin]_MainColor("_MainColor", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				Gradient gradient11 = NewGradient( 0, 4, 2, float4( 1, 0.8777325, 0, 0.1382315 ), float4( 1, 0.09557031, 0.006820879, 0.3823606 ), float4( 1, 0.3157975, 0, 0.6558785 ), float4( 0, 0, 0, 1 ), 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float4 appendResult20 = (float4(SampleGradient( gradient11, ( IN.ase_texcoord7.xyz.z + 0.9 ) ).r , SampleGradient( gradient11, ( IN.ase_texcoord7.xyz.z + 0.9 ) ).g , SampleGradient( gradient11, ( IN.ase_texcoord7.xyz.z + 0.9 ) ).b , 0.0));
				float2 texCoord27 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner28 = ( _TimeParameters.x * float2( 0.2,0.2 ) + texCoord27);
				float simplePerlin2D26 = snoise( panner28 );
				simplePerlin2D26 = simplePerlin2D26*0.5 + 0.5;
				
				float3 Albedo = ( _MainColor * ( appendResult20 * ( simplePerlin2D26 + 0.1 ) ) ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				Gradient gradient11 = NewGradient( 0, 4, 2, float4( 1, 0.8777325, 0, 0.1382315 ), float4( 1, 0.09557031, 0.006820879, 0.3823606 ), float4( 1, 0.3157975, 0, 0.6558785 ), float4( 0, 0, 0, 1 ), 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float4 appendResult20 = (float4(SampleGradient( gradient11, ( IN.ase_texcoord2.xyz.z + 0.9 ) ).r , SampleGradient( gradient11, ( IN.ase_texcoord2.xyz.z + 0.9 ) ).g , SampleGradient( gradient11, ( IN.ase_texcoord2.xyz.z + 0.9 ) ).b , 0.0));
...
/*ASEBEGIN
Version=18923
6.4;11.2;1523.2;783.8;1704.082;706.6365;1.634627;True;False
Node;AmplifyShaderEditor.PosVertexDataNode;13;-1467.904,90.43391;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;23;-1399.296,-340.3507;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;27;-1500.121,-259.205;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GradientNode;11;-1399.747,-52.69999;Inherit;False;0;4;2;1,0.8777325,0,0.1382315;1,0.09557031,0.006820879,0.3823606;1,0.3157975,0,0.6558785;0,0,0,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;16;-1246.956,161.484;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.9;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;28;-1192.909,-252.1462;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0.2,0.2;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;26;-995.9005,-265.9571;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GradientSampleNode;12;-1060.747,-2.699993;Inherit;True;2;0;OBJECT;;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;20;-661.3574,12.41476;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleAddOpNode;29;-737.5557,-205.4971;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;30;-487.9195,-431.6922;Inherit;False;Property;_MainColor;_MainColor;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-435.0125,-121.0356;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-232.9172,-142.3631;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;WolfShader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=1B47274B499C55824B34ED9702C6A0B18571EA63