...
namespace Norsevar.Room_Generation
{
    ...
    public class VectorLabelsAttributeDrawer : PropertyDrawer
    {
        ...
        private static readonly GUIContent[] defaultLabels = { new("X"), new("Y"), new("Z"), new("W") };
        ...
        private T[] DrawFields<T>(
            ...
            T[]                          vector,
            string                       mainLabel,
            Func<Rect, GUIContent, T, T> fieldDrawer,
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                float[] array = { property.vector4Value.x, property.vector4Value.y, property.vector4Value.z, property.vector4Value.w };
                array = DrawFields(position, array, ObjectNames.NicifyVariableName(property.name), EditorGUI.FloatField, vectorLabels);
