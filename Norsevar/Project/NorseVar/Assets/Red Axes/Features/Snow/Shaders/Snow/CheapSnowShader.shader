...
Shader "CheapSnow"
{
	Properties
	{
		...
		[ASEEnd]_Splat1("Splat1", 2D) = "white" {}
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 tex2DNode184 = tex2Dlod( _Control, float4( uv_Control, 0, 0.0) );
				float4 ControlColor186 = tex2DNode184;
				float4 break190 = ControlColor186;
				float lerpResult201 = lerp( 1.0 , break190.b , _SnowControlMapUsage);
				float2 texCoord193 = v.texcoord.xy * float2( 50,50 ) + _NoiseOffset;
				float simpleNoise194 = SimpleNoise( texCoord193*_NoiseScale );
				float lerpResult196 = lerp( 1.0 , break190.g , _NoiseSnowControlMapUsage);
				float NoiseSnowHeight202 = ( simpleNoise194 * lerpResult196 * _NoiseSnowHeightMultiplier );
				float TotalSnowHeight212 = ( ( _SnowHeightMultiplier * lerpResult201 ) + NoiseSnowHeight202 + _MinSnowHeight );
				float3 SnowWorldPos318 = ( ase_worldNormal * TotalSnowHeight212 );
						 ...
						 ) : SV_Target
			{
				...
				float4 GroundTexture357 = tex2D( _Splat1, uv_Splat1 );
				float2 uv_Control = IN.ase_texcoord7.xy * _Control_ST.xy + _Control_ST.zw;
				float4 tex2DNode184 = tex2D( _Control, uv_Control );
				float GroundTextureUsage323 = tex2DNode184.g;
				float4 lerpResult328 = lerp( float4( 0,0,0,0 ) , GroundTexture357 , GroundTextureUsage323);
				float4 GroundColor332 = lerpResult328;
				float2 uv_Splat2 = IN.ase_texcoord7.xy * _Splat2_ST.xy + _Splat2_ST.zw;
				float4 RockTexture363 = tex2D( _Splat2, uv_Splat2 );
				float RockTextureUsage324 = tex2DNode184.b;
				float4 lerpResult330 = lerp( float4( 0,0,0,0 ) , RockTexture363 , RockTextureUsage324);
				float4 RockColor333 = lerpResult330;
				...
				float SnowTextureUsage322 = tex2DNode184.r;
				float4 lerpResult334 = lerp( float4( 0,0,0,0 ) , ( float4( appendResult278 , 0.0 ) * tex2D( _SnowTex, texCoord263 ) ) , SnowTextureUsage322);
				float4 SnowColor290 = lerpResult334;
				float4 ControlColor186 = tex2DNode184;
				float4 lerpResult304 = lerp( ( GroundColor332 + RockColor333 + SnowColor290 ) , ControlColor186 , _ControlView);
				float4 FinalColor302 = lerpResult304;
				...
				float4 Control2Color277 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap );
				
				float4 break281 = ControlColor186;
				
				float3 Albedo = FinalColor302.rgb;
				float3 Normal = Normal289;
				float3 Emission = float3(0,0,0);
				float3 Specular = 0.5;
				float Metallic = Control2Color277.r;
				float Smoothness = break281.a;
				float Occlusion = 1;
				float Alpha = ( break281.r + break281.g + break281.b + break281.a );
...
/*ASEBEGIN
Version=18923
0;0;1536;843;5201.2;3801.609;1.952824;True;True
Node;AmplifyShaderEditor.CommentaryNode;321;-5547.859,-2950.218;Inherit;False;2352.578;1027.003;Comment;10;253;182;328;329;330;331;332;333;366;367;ControlMaps;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;182;-5493.335,-2789.736;Inherit;False;1013.646;362.1724;;6;324;323;322;186;184;183;ControlMap;1,1,1,1;0;0
Node;AmplifyShaderEditor.TexturePropertyNode;183;-5443.335,-2738.369;Inherit;True;Property;_Control;Control;5;0;Create;True;0;0;0;False;0;False;None;182143b1d9bfbe04fbeb575e3c3c07e7;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;184;-5192.356,-2736.32;Inherit;True;Property;_TextureSample13;Texture Sample 13;13;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;186;-4746.755,-2758.826;Inherit;False;ControlColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;185;-4750.592,54.42982;Inherit;False;2844.611;940.2597;;27;311;308;255;245;243;241;239;212;208;207;206;204;202;201;199;198;197;196;195;194;193;192;191;190;189;188;187;Snow Height;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;340;-5594.113,-4238.005;Inherit;False;2415.924;1187.086;;3;348;346;365;Splats;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;346;-4443.317,-4169.14;Inherit;False;978.9736;498.8228;;6;342;350;355;356;357;358;Ground;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;365;-4421.235,-3603.281;Inherit;False;910.3767;483.6118;;6;364;363;361;362;360;359;Rock;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;188;-3726.199,322.6717;Inherit;True;186;ControlColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector2Node;189;-4704.645,487.7411;Inherit;False;Property;_NoiseOffset;NoiseOffset;14;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.CommentaryNode;249;-4765.505,-1534.684;Inherit;False;1673.988;640.605;Snow Color lerped between the un-displaced and displaced snow textures.;9;290;282;278;268;259;263;266;334;335;Snow Color;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;191;-3824.35,616.2246;Inherit;False;Property;_NoiseSnowControlMapUsage;NoiseSnowControlMapUsage;12;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;342;-4396.659,-4104.389;Inherit;True;Property;_Splat1;Splat1;16;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.BreakToComponentsNode;190;-3500.41,326.5647;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.RangedFloatNode;192;-4084.476,699.6387;Inherit;False;Property;_NoiseScale;NoiseScale;1;0;Create;True;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;359;-4377.686,-3531.779;Inherit;True;Property;_Splat2;Splat2;15;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;195;-3176.354,658.4616;Inherit;False;Property;_NoiseSnowHeightMultiplier;NoiseSnowHeightMultiplier;9;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;362;-4084.431,-3530.557;Inherit;True;Property;_TextureSample19;Texture Sample 16;19;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;355;-4103.407,-4103.167;Inherit;True;Property;_TextureSample16;Texture Sample 16;19;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;266;-4370.685,-1484.684;Inherit;False;Property;_MainColor;MainColor;0;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.854902,0.9660377,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;196;-3408.424,571.3281;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;357;-3765.085,-4102.064;Inherit;False;GroundTexture;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;268;-4384.667,-1282.472;Inherit;True;Property;_TextureSample14;Texture Sample 2;7;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;197;-3124.96,515.1073;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;323;-4747.149,-2609.136;Inherit;False;GroundTextureUsage;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;198;-3336.749,174.8245;Inherit;False;Property;_SnowControlMapUsage;SnowControlMapUsage;13;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;322;-4753.149,-2686.136;Inherit;False;SnowTextureUsage;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;324;-4751.149,-2529.136;Inherit;False;RockTextureUsage;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;363;-3746.109,-3529.454;Inherit;False;RockTexture;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;199;-2777.996,158.1051;Inherit;False;Property;_SnowHeightMultiplier;SnowHeightMultiplier;10;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;201;-2926.445,249.3772;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;329;-3682.779,-2661.579;Inherit;False;323;GroundTextureUsage;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;367;-4014.031,-2572.343;Inherit;False;363;RockTexture;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;366;-4014.032,-2767.22;Inherit;False;357;GroundTexture;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;331;-3683.505,-2467.66;Inherit;False;324;RockTextureUsage;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;335;-3550.134,-1274.836;Inherit;False;322;SnowTextureUsage;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;207;-2736.409,232.0275;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;330;-3656.055,-2587.7;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;328;-3655.329,-2781.619;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;204;-2543.648,665.7465;Inherit;False;Property;_MinSnowHeight;MinSnowHeight;7;0;Create;True;0;0;0;False;0;False;0.1;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;287;-2945.865,-2520.835;Inherit;False;1585.724;1131.139;Final Color;8;302;305;309;304;336;337;339;338;Final Color;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;333;-3441.288,-2591.088;Inherit;False;RockColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;253;-5494.628,-2373.181;Inherit;False;901.6064;379.139;;3;277;267;256;ControlMap 2;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;332;-3448.288,-2787.088;Inherit;False;GroundColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;339;-2928.153,-2250.129;Inherit;False;290;SnowColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;338;-2928.153,-2333.129;Inherit;False;333;RockColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;337;-2940.153,-2415.129;Inherit;False;332;GroundColor;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;256;-5465.718,-2322.999;Inherit;True;Property;_MetallicGlossMap;MetallicGlossMap;11;0;Create;True;0;0;0;False;0;False;None;182143b1d9bfbe04fbeb575e3c3c07e7;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.CommentaryNode;319;-4659.337,1108.354;Inherit;False;800.926;479.3634;;4;315;316;317;318;Displacement;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;309;-2594.042,-2095.239;Inherit;False;Property;_ControlView;ControlView;8;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;276;-2419.87,-805.0005;Inherit;False;273;SnowNormal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;275;-1039.732,210.9152;Inherit;False;186;ControlColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;315;-4514.337,1405.318;Inherit;False;212;TotalSnowHeight;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldNormalVector;316;-4508.176,1250.354;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleAddOpNode;336;-2684.153,-2354.129;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;267;-5218.818,-2323.399;Inherit;True;Property;_TextureSample15;Texture Sample 15;17;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;305;-2710.865,-2205.196;Inherit;False;186;ControlColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;304;-2510.087,-2221.759;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;277;-4879.649,-2324.803;Inherit;False;Control2Color;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.BreakToComponentsNode;281;-813.02,210.8392;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;317;-4264.17,1337.906;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;348;-5551.807,-4165.306;Inherit;False;1055.609;492.5666;;4;349;347;353;354;Snow;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;302;-2291.877,-2228.069;Inherit;False;FinalColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;284;-1054.463,60.59773;Inherit;False;277;Control2Color;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;293;-516.1443,339.7248;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;318;-4087.211,1331.082;Inherit;False;SnowWorldPos;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;360;-4372.473,-3330.414;Inherit;True;Property;_Normal2;Normal2;18;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.GetLocalVarNode;299;-146.7306,13.91762;Inherit;False;289;Normal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;356;-4106.749,-3898.628;Inherit;True;Property;_TextureSample17;Texture Sample 16;19;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.BreakToComponentsNode;288;-815.2629,67.09773;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;358;-3762.584,-3899.527;Inherit;False;GroundNormal;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;313;-343.2232,267.9935;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;353;-5268.978,-4096.652;Inherit;True;Property;_Control1;Control;6;0;Create;True;0;0;0;False;0;False;None;182143b1d9bfbe04fbeb575e3c3c07e7;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;350;-4389.296,-3900.874;Inherit;True;Property;_Normal1;Normal1;17;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.WireNode;312;-318.1431,54.86136;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;354;-4949.312,-4023.33;Inherit;False;Sample4Splats4Normals;-1;;25;45f7d1aa5e9d58743aec839bd3751783;0;9;54;SAMPLER2D;0;False;55;SAMPLER2D;0;False;56;SAMPLER2D;0;False;57;SAMPLER2D;0;False;58;SAMPLER2D;0;False;100;SAMPLER2D;0;False;101;SAMPLER2D;0;False;105;SAMPLER2D;0;False;102;SAMPLER2D;0;False;2;COLOR;0;FLOAT3;132
Node;AmplifyShaderEditor.TexturePropertyNode;349;-5511.278,-3904.587;Inherit;True;Property;_Normal0;Normal0;20;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;347;-5509.267,-4104.521;Inherit;True;Property;_Splat0;Splat0;19;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;361;-4089.924,-3328.167;Inherit;True;Property;_TextureSample18;Texture Sample 16;19;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;303;-149.4459,-64.22919;Inherit;False;302;FinalColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;364;-3743.609,-3326.917;Inherit;False;RockNormal;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;304;0;336;0
WireConnection;304;1;305;0
WireConnection;304;2;309;0
...
WireConnection;293;0;281;0
WireConnection;293;1;281;1
WireConnection;293;2;281;2
WireConnection;293;3;281;3
...
WireConnection;354;54;353;0
WireConnection;354;55;347;0
WireConnection;354;100;349;0
...
WireConnection;16;3;288;0
WireConnection;16;4;281;3
WireConnection;16;6;313;0
WireConnection;16;7;291;0
WireConnection;16;8;320;0
ASEEND*/
//CHKSM=A4E5017856A37F43EEB7E21C722FBC44B2BCBD74